		...
		<div class="site-info" theme-info="Sakurairo v<?php echo IRO_VERSION; ?>">
			...
			<div class="footer-device function_area">
					...
					<span style="color: #b9b9b9;">
                        ...
                        <?php endif; ?>
                        <br>
						<a href="https://github.com/mirai-mamori/Sakurairo" rel="noopener" target="_blank" id="site-info-theme-name" >Theme Sakurairo</a><a href="https://fuukei.org/" rel="noopener" target="_blank" id="site-info-theme-author" > by Fuukei</a> 
					</span>
			</div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
